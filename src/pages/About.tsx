...
export const About = () => {
    ...
    return (
        <div
            ...
            id="about" 
            className="w-screen bg-black text-stone-200 flex laptop:flex-col-reverse justify-center p-20 tablet:p-10 mobileG:p-5 mobileM:p-2"
        >
            <div className="flex-1 flex flex-col justify-center gap-3">
                ...
                <a href="https://wa.me/5548996312210?text=Olá+consegui+seu+contato+atravéz+de+seu+site!" target="_blank" className='mobileGG:w-full mobileGG:flex mobileGG:justify-center mobileGG:mt-10'>
                ...
                <div className="font-montserrat flex flex-col items-start mt-10 transitions">
